                ...
                <tr v-for="owner in projectOwners.data" :key="owner.id" class="hover:bg-white/30 dark:hover:bg-indigo-500/10 transition duration-200">
                  ...
                  <td class="p-5 align-middle">
                    <a
                      ...
                      class="font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 hover:underline decoration-indigo-300 underline-offset-2 transition"
                    >
                      {{ owner.name }}
                    </a>
                  </td>
