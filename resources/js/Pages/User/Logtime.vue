...
:deep(.dp__input) {
  ...
  font-size: 0.875rem;
  font-weight: 500;
  color: #374151; /* gray-700 untuk light mode */
}

:deep(.dp__input::placeholder) {
  color: #6b7280; /* gray-500 untuk light mode */
  opacity: 1;
}
...
/* CSS VARIABLES KHUSUS VUE-DATEPICKER UNTUK DARK MODE */
:global(.dark) {
  --dp-background-color: rgba(15, 23, 42, 0.5);
  --dp-text-color: #f1f5f9;
  --dp-hover-color: rgba(255, 255, 255, 0.1);
  --dp-hover-text-color: #ffffff;
  --dp-hover-icon-color: #ffffff;
  --dp-primary-color: #2876bc;
  --dp-primary-text-color: #ffffff;
  --dp-secondary-color: #94a3b8;
  --dp-border-color: rgba(255, 255, 255, 0.1);
  --dp-menu-border-color: rgba(255, 255, 255, 0.1);
  --dp-border-color-hover: #2876bc;
  --dp-icon-color: #94a3b8;
}

/* Override paksa untuk input utama (glass-datepicker) di Dark Mode */
:global(.dark) :deep(.glass-datepicker) {
  background-color: rgba(15, 23, 42, 0.5) !important; 
  border-color: rgba(255, 255, 255, 0.1) !important;
  color: #f1f5f9 !important;
}

/* Paksa warna placeholder di dark mode agar terbaca */
:global(.dark) :deep(.glass-datepicker::-webkit-input-placeholder) {
  color: #94a3b8 !important; /* slate-400 */
  opacity: 1 !important;
}
:global(.dark) :deep(.glass-datepicker::-moz-placeholder) {
  color: #94a3b8 !important;
  opacity: 1 !important;
}
:global(.dark) :deep(.glass-datepicker::placeholder) {
  color: #94a3b8 !important;
  opacity: 1 !important;
}

/* Tampilan Menu Kalender di Dark Mode */
