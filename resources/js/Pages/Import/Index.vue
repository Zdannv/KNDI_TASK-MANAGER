<script setup>
import Cloud from '@/Components/Icon/Cloud.vue'; // Icon Import sudah benar
        ...
        <div class="flex flex-col items-start">
            ...
            <div class="relative z-10 -mb-[1px]">
                <div class="w-40 h-10 bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm border-t border-l border-r border-slate-200 dark:border-slate-800 rounded-t-xl shadow-[0_-2px_5px_rgba(0,0,0,0.02)] relative flex items-center px-4">
                    <Cloud class="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                    <div class="absolute -bottom-[1px] left-0 right-0 h-[2px] bg-white/70 dark:bg-slate-900/70 z-20"></div>
                </div>
            </div>

            <div class="w-full bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm border border-slate-200 dark:border-slate-800 shadow-lg dark:shadow-sm shadow-indigo-500 dark:shadow-indigo-800 rounded-b-xl rounded-tr-xl rounded-tl-none relative z-0 p-8 space-y-6">
